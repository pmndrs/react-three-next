// With this script, you can move multiple group objects.
// Before my improvement, you can move only one group object like official example.
    ...
    constructor(_objects, _camera, _domElement) {
        ...
        function onPointerDown(event) {
            ...
            for (let i = 0; i < _objects.length; i++) {
                _intersections.length = 0;
                _raycaster.intersectObject(_objects[i], true, _intersections);
                if (_intersections.length > 0) {
                    this.selectedID = i;
                    break;
                }
